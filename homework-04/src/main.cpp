...
// EN: homework-04 — control system with feedback. The ESP32 is a
//     WebSocket client of the Node hub (port 8811). Browser buttons
//     send `LED` commands which set `greenIntention`; the chip
//     drives the green LED accordingly. A photoresistor on GPIO 32
//     is read at ~20 Hz and streamed back as `fotoupornik`.
//
//     Step 3 — feedback loop. The chip compares intention vs LDR:
...
// SL: homework-04 — kontrolni sistem s povratno zanko. ESP32 je
...
//
//     Korak 3 — povratna zanka. Čip primerja ukaz in meritev LDR:
