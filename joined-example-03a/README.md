# Joined example 03a — Visualise button events on an HTML5 canvas
...
```powershell
# from joined-example-03a/node-example-11/
npm install
npm start

# from joined-example-03a/
...
```powershell
# iz joined-example-03a/node-example-11/
npm install
npm start

# iz joined-example-03a/
pio run --target upload
pio device monitor
```
